                                ...
                                <div className="flex flex-col w-full max-w-full px-3 mx-left md:w-7/12 lg:w-5/12 xl:w-4/12">
                                    <div className="relative flex flex-col border-0 shadow-none lg:py4 rounded-2xl bg-transparent">
                                        <div className="p-6 pb-0 mb-0">
                                            <h4 className="font-bold z-20 mt-12 text-white text-5xl">Đăng Nhập</h4>
                                        ...
                                        <div className="flex-auto p-6">
                                            <form>
                                                ...
                                                <div className="flex items-center pl-12 mb-0.5">
                                                    <input id="rememberMe" type="checkbox" className="h-5 w-10 cursor-pointer rounded-10 bg-zinc-700/10 border border-gray-200" />
                                                    <label htmlFor="rememberMe" className="ml-2 text-sm text-slate-700">Remember me</label>
                                                </div>
                                                <div className="text-center">
                                                    <button type="submit"
                                                        className="inline-block w-full px-16 py-3.5 mt-6 font-bold text-white bg-blue-500 rounded-lg shadow-md hover:-translate-y-px hover:shadow-xs active:opacity-85 text-sm transition-all">
                                                        Đăng Nhập
                                                    </button>
                                                </div>
                                            </form>
                                        ...
                                        <div className="border-t border-black/12.5 p-6 text-center pt-0 px-1 sm:px-6">
                                            <p className="text-sm">Bạn chưa có tài khoản SUDES SPORT? Đăng ký ngay!  <a href="/admin/auth/sign_up" className="font-semibold bg-clip-text text-transparent bg-gradient-to-tl from-blue-500 to-violet-500">Đăng Ký</a></p>
                                        </div>
                                    </div>
                                </div>

        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-3xl bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-purple-100/50">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight capitalize">Trung tâm trợ giúp</h2>
                ...
                <div className="space-y-8 text-gray-700">
                    <section className="">
                        ...
                        <p className="mt-2 text-sm leading-relaxed flex">
                            Tiếp nhận mọi khiếu nại của khách hàng liên quan đến việc sử dụng dịch vụ của <div className="ml-1 italic text-g">Sportigo</div>.
                        </p>
                    </section>
